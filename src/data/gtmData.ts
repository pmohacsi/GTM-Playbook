...
export const STAKEHOLDERS: Stakeholder[] = [
  ...
  },
  {
    ...
    phases: [
      ...
      { phaseId: 'phase4', role: 'owner', description: 'Owner: internal product enablement plan, training and product knowledge needs. Strong contribution: Sales playbook contribution for product-related plays – defining product-specific use cases, discovery guidance, demo/storyline inputs and qualification perspectives for Sales Enablement.' },
      { phaseId: 'phase5', role: 'owner', description: 'Owner: internal product knowledge assets, training, product explanation and scenario logic. Strong contribution to product-related sales plays: product-specific content input, scenario one-pagers, demo logic, value proof and "how to explain the product" guidance.' },
